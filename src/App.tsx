...
function App() {
  ...
  return (
    <div className={`w-full h-screen ${theme ? "bodyDark" : "bodyLight"}`}>
      <StoreContext.Provider value={{ store, setstore, data, theme, settheme, setActiveBoard,sideBar,setsideBar }}>
        <Sidebar />
